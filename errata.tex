...
We also notice that the product state $\ket{\Psi_{0}}$ has $\overline{P_{\fh}}=3=0$
over $\ff{3^{2}}$ so $\overline{P_{\fh}}=0$ is not a good defintion
for maximally entangled states. Because of the experience on product
states, $\forall j,\overline{P_{\fh}^{j}}=0$ may also be too weak
to definition of maximally entangled states. Indeed, a discrete maximally
entangled state should be defined as 
\begin{equation}
...
\end{equation}
and in general for $n$-qubits, $p^{n}\left(p-1\right)^{n}$ instances
...
$p=3$, there are $2195538048$ instances of pure maximally entangled
states, while the general formula for four-qubit states remains unclear.

\yutsung{
\begin{eqnarray*}
2195538048 & = & 4\cdot548884512\\
548884512 & = & 2^{5}\cdot3^{7}\cdot11\cdot23\cdot31
\end{eqnarray*}
The irreducible state counts for maximal entanglement for $n=4$ and
$p=7$ is about $8.22\times10^{14}$.}


\ack{}{We would like to thank John Cardiner for pointing out the need for
this correction. For counting maximally entangled states for $p=3$
and $n=4$, we also need to thank to Lilly Endowment, Inc., through
its support for the Indiana University Pervasive Technology Institute,
and in part by the Indiana METACyt Initiative. The Indiana METACyt
Initiative at IU is also supported in part by Lilly Endowment, Inc.}
